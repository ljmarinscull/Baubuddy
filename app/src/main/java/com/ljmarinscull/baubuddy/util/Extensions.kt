...
fun newResources() = listOf(
    ...
    ResourceEntity(
        ...
        sort = "0",
        wageType = "WageType 3",
        businessUnitKey = "BusinessUnitKey 3",
        businessUnit = "BusinessUnit 3",
        parentTaskID = "ParentTaskID 3",
        prePlanningBoardQuickSelect = "PrePlanningBoardQuickSelect 3",
        colorCode = "#2e2eFF",
        workingTime = "workingTime 3",
        isAvailableInTimeTrackingKioskMode = false,
    )
)
